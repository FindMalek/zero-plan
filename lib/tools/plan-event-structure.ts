...
export const planEventStructureTool = tool({
  description:
    "Create detailed, intelligent event structure and timing using AI-based planning",
      ...
      schema: z.object({
        eventSequence: z.array(
          z.object({
            ...
            category: z
              .string()
              .describe("Event category (social, work, travel, etc.)"),
            startTime: z
              .string()
              .describe("ISO datetime string for event start"),
            ...
            dependencies: z
              .array(z.string())
              .describe("Event IDs this depends on"),
            travelInfo: z
              .object({
                isTravel: z.boolean(),
        ...
        timingStrategy: z.object({
          ...
          flexibility: z
            ...
            .describe("How flexible the timing is"),
          considerations: z
            .array(z.string())
            .describe("Important timing considerations"),
        }),
        coordinationPlan: z.object({
          needsConfirmation: z
            .boolean()
            .describe("Whether events need confirmation"),
          conflictRisks: z
            .array(z.string())
            .describe("Potential scheduling conflicts"),
          optimizations: z
            .array(z.string())
            .describe("Suggested optimizations"),
          alternativeOptions: z
            .array(z.string())
            .describe("Alternative timing options"),
        }),
        culturalConsiderations: z.object({
          localCustoms: z.array(z.string()).describe("Relevant local customs"),
          socialExpectations: z
            .array(z.string())
            .describe("Social expectations to consider"),
          practicalFactors: z
            .array(z.string())
            .describe("Practical factors for Tunisia"),
        }),
        confidence: z.number().min(0).max(1).describe("Confidence in the plan"),
        recommendedAdjustments: z
          .array(z.string())
          .describe("Suggested adjustments to improve the plan"),
      }),
